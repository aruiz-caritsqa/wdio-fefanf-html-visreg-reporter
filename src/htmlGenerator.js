...
class VisRegHtmlGenerator  {
    ...
    static htmlOutput(reportOptions, callback = () =>{}) {
        try {
            ...
            //     if (event.type.includes('innerStepPass')) {
            //         return hbopts.fn(this);
            //     }
            //     return hbopts.inverse(this);
            // });            

            // Handlebars.registerHelper('ifEventIsInnerStepFail', function (event, hbopts) {
            //     if (event.type.includes('innerStepFail')) {
            //         return hbopts.fn(this);
            //     }
            //     return hbopts.inverse(this);
            // });            
            ...
            Handlebars.registerHelper('ifEventIsVisRegPass', function (event, hbopts) {
                if (event.type.includes('imgComparePass')) {
                    return hbopts.fn(this);
                }
                return hbopts.inverse(this);
            });            

            Handlebars.registerHelper('ifEventIsVisRegFail', function (event, hbopts) {
                if (event.type.includes('imgCompareFail')) {
                    return hbopts.fn(this);
                }
                return hbopts.inverse(this);
            });            

            Handlebars.registerHelper('ifEventIsVisRegSkip', function (event, hbopts) {
                if (event.type.includes('imgCompareNew')) {
                    return hbopts.fn(this);
                }
                return hbopts.inverse(this);
            });                        
...
export default VisRegHtmlGenerator;
